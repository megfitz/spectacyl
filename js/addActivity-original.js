...
var userActivities = new Firebase('https://intense-fire-4545.firebaseio.com/');
...
$(".submitButton").click(function () {
	...
	userActivities.push({name: $activityName, type: $activityType, date: $activityDate, description: $activityDescription});	
});

// For each child element in the Firebase database
userActivities.on('child_added', function (snapshot) {
